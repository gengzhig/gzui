	...
	ctx.response.body = {
		...
		data: [
			...
			},
			{
				...
				render: `() => <gzCheckBox width={"100%"} height={"100%"} inputType="text" list="[]"></gzCheckBox>`,
				key: "0009",
				style: {
					width: 200,
					height: 40,
			...
			},
			{
				...
				render: '() => <gz-switch width={"100%"} height={"100%"} text="开|关" activeColor="#13ce66" inactiveColor="#fdfdfd"></gz-switch>',
				key: "0013",
				style: {
					width: 150,
					height: 26,
