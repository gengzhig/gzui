let tools = {
	...
	createGroupStyle(groupComponent) {
		...
		groupComponent.group.forEach(component => {
	...
	async runAnimation($el, animations = []) {
	...
	decomposeComponent(component, editorRect, parentStyle) {
		...
		component.style.rotate = tools.mod360(component.style.rotate + parentStyle.rotate);
		component.style.width = parseInt((parseFloat(component.groupStyle.width) / 100) * parentStyle.width);
		component.style.height = parseInt((parseFloat(component.groupStyle.height) / 100) * parentStyle.height);
		// 计算出元素新的 top left 坐标
		component.style.left = parseInt(center.x - component.style.width / 2);
		component.style.top = parseInt(center.y - component.style.height / 2);
